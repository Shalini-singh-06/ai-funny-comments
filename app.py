...
#     try:
#         # Extract video ID (works for shorts & normal videos)
#         video_id = None
#         if "v=" in url:
...
#         except Exception:
#             transcript_text = ""  # No captions available
...
#             combined_text += " (Funny short video, make creative reactions!)"
...
#         print(f"⚠️ Error while fetching video info: {e}")
#         return None
...
#     prompt = f"""
#     Tum ek funny aur creative Instagram Reels Comment Generator ho 😎  
#     Niche diye gaye video ke liye 10 unique, mast, aur engaging funny comments likho.  
#     Comments **Hinglish (Hindi + English mix)** me ho, har ek comment alag tone me —  
#     jaise savage, emotional, cute, sarcastic, ya overacting-type funny.  
#     Har comment me emoji use karo (natural way me), aur 1 line me short rakho (8–12 words).  
#     Har comment alag lagna chahiye, real insaan likha ho aisa vibe dena.  
...
#     # Fetch video info
#     desc = fetch_youtube_info(link)
#     if not desc:
#         return jsonify({"error": "Unable to fetch video info"}), 400
